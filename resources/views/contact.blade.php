            ...
            <form class="w-full max-w-lg my-5" method="POST" action="/contact">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border @error('name') {{'border-red-500'}} @enderror rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="name" id="grid-first-name" type="text" placeholder="Your name" value="{{old('name')}}">
